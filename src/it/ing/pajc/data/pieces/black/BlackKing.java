...
/**
 * BlackKing class defines black king pieces with all implemented methods.
 */
public class BlackKing extends King {
    ...
    /**
     * BlackKing's constructor giving position.
     *
     * @param pos BlackKing's position
     */
    public BlackKing(Position pos) {
        super(pos);
