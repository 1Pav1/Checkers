...
public abstract class King extends Pieces {
     ...
     * @param parentPositions starting position of the creating tree.
     */
    public abstract void possibleCapturesAllDirections(ItalianBoard board, GenericTreeNode<Position> parentPositions);
     ...
     * @param parentPositions starting position of the creating tree.
     */
    public abstract void possibleCaptureDownLeft(ItalianBoard board, GenericTreeNode<Position> parentPositions);
     ...
     * @param parentPositions starting position of the creating tree.
     */
    public abstract void possibleCaptureDownRight(ItalianBoard board, GenericTreeNode<Position> parentPositions);
